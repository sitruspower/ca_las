...
function [active] = func_active_cells3D(struct, dx) %, xslice, yslice, zslice, xi, yi, zi, xmin, ymin, zmin)
...
%     end
% %     active=newactive;
%     active(:,:) = active(:,:) + ones(length(active(:,1)), 1)*[1,1,0];
